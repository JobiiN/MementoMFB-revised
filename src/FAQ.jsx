                    ...
                    return (
                        <div className="qcon" key={i}>
                            <button
                                ...
                                className="mqcon" onClick={() => setOpenIndex(isOpen ? null : i)}>
                                <span className="question">{faq.q}</span>
                                <span className={`up ${isOpen ? 'up--open' : ''}`}>
